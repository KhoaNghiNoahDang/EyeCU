...
TID = "54943144-80c7-701c-e063-62199f0a88a8"
...
async def test_summary():
    ...
    try:
        async with httpx.AsyncClient(timeout=30) as client:
            resp = await client.post("https://api.idg.vnpt.vn/eval-emotion-service/v1/conversation/summary-meeting", headers=headers, files={"file": ("test.wav", wav_bytes, "audio/wav")}, data={"maxNumSpeakers": "2", "languageCode": "vi-VN"})
